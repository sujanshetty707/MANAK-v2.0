...
export const BottomNav: React.FC = () => {
  ...
  if (userRole === 'officer') {
    ...
    return (
      <nav className="bg-white border-t border-slate-200/90 py-1.5 px-3 flex items-center justify-around shadow-nav relative z-20 flex-shrink-0">
        {navItems.map(item => {
  ...
  return (
    <nav className="bg-white border-t border-slate-200/90 py-2 px-6 flex items-center justify-around shadow-nav relative z-20 flex-shrink-0">
